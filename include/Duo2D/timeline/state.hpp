...
namespace d2d::timeline {
	template<sl::size_t N, resource_table<N> Resources, sl::size_t CommandGroupCount>
	struct state {
		//using draw_buffer_offsets_type = sl::lookup_table<impl::draw_command_buffer_filtered_index_sequence<N, Resources, CommandGroupCount>::size(), resource_key_t, sl::size_t>;
	public:
