...
namespace d2d::vk {
    ...
    result<pipeline_layout<Stages, T, N, Resources>> pipeline_layout<Stages, T, N, Resources>::create(std::shared_ptr<logical_device> device) noexcept {
        pipeline_layout ret{};
		...
		using push_constant_usage_filtered_sequence = sl::filtered_sequence_t<sl::index_sequence_of_length_type<N>, []<sl::index_t I>(sl::index_constant_type<I>){ 
			constexpr resource_config cfg = sl::universal::get<sl::second_constant>(*std::next(Resources.begin(), I));
