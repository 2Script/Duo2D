...
namespace d2d::vk {
    ...
    result<descriptor_pool> descriptor_pool::create(std::shared_ptr<logical_device> device, std::span<VkDescriptorPoolSize, N> pool_sizes, std::uint32_t max_sets, std::bitset<N> enabled_bindings) noexcept {
        descriptor_pool ret{};
