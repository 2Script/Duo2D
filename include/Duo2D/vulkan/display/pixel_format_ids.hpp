...
namespace d2d::vk::impl {
    constexpr std::array<VkFormat, num_pixel_formats> pixel_format_ids = {
        ...
        VK_FORMAT_R8_USCALED, VK_FORMAT_R8_SSCALED,
        ...
        VK_FORMAT_B8G8R8_UNORM, VK_FORMAT_B8G8R8_SNORM,
        VK_FORMAT_B8G8R8_USCALED, VK_FORMAT_B8G8R8_SSCALED,
        ...
        VK_FORMAT_R16_USCALED, VK_FORMAT_R16_SSCALED,
