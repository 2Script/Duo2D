...
namespace d2d {
    ...
    public:
        result<void> record(const window& w, std::vector<VkBuffer>& vertex_buffers, shader_buffer& index_buffer, VkDescriptorSet const* desc_sets, std::vector<std::size_t>& offsets, std::size_t index_count, std::uint32_t image_index) const noexcept;
