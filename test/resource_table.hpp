...
constexpr d2d::resource_table<resource_id::num_resource_ids> resource_configs{{{
	...
	{resource_id::counts, {d2d::memory_policy::shared, d2d::buffering_policy::single, d2d::usage_policy::draw_count | d2d::usage_policy::generic, 0, sizeof(d2d::draw_count_t) + sizeof(sl::uint32_t)}},
	{resource_id::draw_commands, {d2d::memory_policy::shared, d2d::buffering_policy::single, d2d::usage_policy::draw_commands, 0, 256 * sizeof(d2d::indexed_draw_command_t)}},
	...
	{resource_id::compute_buffer_addresses, {d2d::memory_policy::shared, d2d::buffering_policy::multi, d2d::usage_policy::generic, 0, 3 * sizeof(d2d::gpu_address_t)}}, //uniform
